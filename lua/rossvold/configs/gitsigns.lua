require("gitsigns").setup({
	...
	on_attach = function(bufnr)
		...
		-- Hunk navigation (mh/Mh)
		-- NOTE: make_repeatable_move_pair was removed in new textobjects API
		-- For now, just use plain hunk navigation without , and ; repeat support
		vim.keymap.set({ "n", "x", "o" }, "mh", gs.next_hunk, { buffer = bufnr })
		vim.keymap.set({ "n", "x", "o" }, "Mh", gs.prev_hunk, { buffer = bufnr })
